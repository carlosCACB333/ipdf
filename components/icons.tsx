...
export const Files: React.FC<IconSvgProps> = ({
  fill = "currentColor",
  size,
  height,
  width,
...
export const PdfFile: React.FC<IconSvgProps> = ({
  fill = "currentColor",
  size,
  height,
  width,
...
export const PngFile: React.FC<IconSvgProps> = ({
  fill = "currentColor",
  size,
  height,
  width,
...
export const FileText: React.FC<IconSvgProps> = ({
  fill = "currentColor",
  size,
  height,
  width,
...
export const Rocket: React.FC<IconSvgProps> = ({
  fill = "currentColor",
  size,
  height,
  width,
...
export const MoodSmile: React.FC<IconSvgProps> = ({
  fill = "currentColor",
  size,
  height,
  width,
